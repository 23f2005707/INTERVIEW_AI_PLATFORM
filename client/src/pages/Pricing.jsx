...
const Pricing = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      price: "₹100",
      credits: 150,
      description: "Great for focused practice and skill improcement.",
      features: [
    ...
    },
    {
      ...
      price: "₹500",
      credits: 650,
      description: "Best value foor serious job preperation.",
      features: [
      ...
      const amount = 
        ...
        const options = {
          ...
          handler:async function(response) {
            ...
            // verify pay request api call 
            const verifyPay = await axios.post(ServerUrl + "/api/payment/verify", 
              response, {withCredentials: true}
            )
            
            // set the userdata 
            dispatch("Payment successful Credits Added!");
  ...
  return (
    <div className='min-h-screen bg-graident-to-br from-gray-50 to-eemrald-50 py-16 px-6'>
